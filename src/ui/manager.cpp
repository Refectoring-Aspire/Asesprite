...
#include "ui/intern.h"
#include "ui/ui.h"
#include "ui/focusMovement.cpp"
#include "ui/internalRoutines.cpp"
...
Manager::Manager()
    : Widget(kManagerWidget), m_display(NULL), m_eventQueue(NULL), m_lockedWindow(NULL), m_mouseButtons(kButtonNone)
{
#ifdef DEBUG_UI_THREADS
...
static MouseButtons mouse_buttons_from_os_to_ui(const os::Event &osEvent)
{
  ...
  {
  case os::Event::LeftButton:
    return kButtonLeft;
    break;
  case os::Event::RightButton:
    return kButtonRight;
    break;
  case os::Event::MiddleButton:
    return kButtonMiddle;
    break;
  case os::Event::X1Button:
    return kButtonX1;
    break;
  case os::Event::X2Button:
    return kButtonX2;
    break;
  default:
    return kButtonNone;
