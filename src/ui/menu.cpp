  ...
  switch (msg->type()) {
    ...
    default:
      if (msg->type() == kOpenMessage) {
        ...
        return kOpenMenuItemMessageFunction();
      }
      else if (msg->type() == kCloseMenuItemMessage) {
        return kCloseMenuItemMessageFunction();
      }
...
boolean MenuItem::kOpenMenuItemMessageFunction() {
  validateItem();
...
boolean MenuItem::kCloseMenuItemMessageFunction() {
